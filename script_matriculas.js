...
function somarValorFinal() {
  ...
  let totalIntegral =
    parseFloat(v1) + parseFloat(v2) + parseFloat(v3) + parseFloat(v4);
  let descontoMes =
    parseFloat(v1 - va1) +
    parseFloat(v2 - va2) +
    parseFloat(v3 - va3) +
  ...
  let somatorio =
    parseFloat(va1) + parseFloat(va2) + parseFloat(va3) + parseFloat(va4);
  ...
  document.getElementById("divSomaTotal").innerHTML = somatorio.toLocaleString(
    "pt-BR",
...
function copiarDados() {
  ...
  if (document.getElementById("checkLaudo1").checked == true) {
    ...
    l1 = " sem laudo/suspeita";
  }
  let dt1 = "";
  if (document.getElementById("checkDidaticos1").checked == true) {
    dt1 = ", didáticos inclusos";
  } else {
    dt1 = ", sem didáticos";
  }
  let pre1 = "";
  if (document.querySelector("#checkPresenca1").checked == true) {
    pre1 = "(ausente)";
  } else {
    pre1 = "(presente)";
  }
  ...
  let l2 = "";
  if (document.getElementById("checkLaudo2").checked == true) {
    l2 = " laudo/suspeita";
  } else {
    l2 = " sem laudo/suspeita";
  }
  let dt2 = "";
  if (document.getElementById("checkDidaticos2").checked == true) {
    dt2 = ", didáticos inclusos";
  } else {
    dt2 = ", sem didáticos";
  }
  let pre2 = "";
  if (document.querySelector("#checkPresenca2").checked == true) {
    pre2 = "(ausente)";
  } else {
    pre2 = "(presente)";
  }
  ...
  let l3 = "";
  if (document.getElementById("checkLaudo3").checked == true) {
    l3 = " laudo/suspeita";
  } else {
    l3 = " sem laudo/suspeita";
  }
  let dt3 = "";
  if (document.getElementById("checkDidaticos3").checked == true) {
    dt3 = ", didáticos inclusos";
  } else {
    dt3 = ", sem didáticos";
  }
  let pre3 = "";
  if (document.querySelector("#checkPresenca3").checked == true) {
    pre3 = "(ausente)";
  } else {
    pre3 = "(presente)";
  }
  ...
  let l4 = "";
  if (document.getElementById("checkLaudo4").checked == true) {
    l4 = " laudo/suspeita";
  } else {
    l4 = " sem laudo/suspeita";
  }
  let dt4 = "";
  if (document.getElementById("checkDidaticos4").checked == true) {
    dt4 = ", didáticos inclusos";
  } else {
    dt4 = ", sem didáticos";
  }
  let pre4 = "";
  if (document.querySelector("#checkPresenca4").checked == true) {
    pre4 = "(ausente)";
  } else {
    pre4 = "(presente)";
  }
